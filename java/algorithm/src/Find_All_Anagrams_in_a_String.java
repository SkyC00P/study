...
public class Find_All_Anagrams_in_a_String {
    /**
     * Runtime: 28 ms, faster than 30.70% of Java online submissions for Find All Anagrams in a String.
     * Memory Usage: 39.7 MB, less than 44.49% of Java online submissions for Find All Anagrams in a String.
     */
    ...
    public static void main(String[] args) {
        Find_All_Anagrams_in_a_String test = new Find_All_Anagrams_in_a_String();
